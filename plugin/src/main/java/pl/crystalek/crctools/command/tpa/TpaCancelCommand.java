...
public final class TpaCancelCommand extends SingleCommand {
    UserCache userCache;

    public TpaCancelCommand(final MessageAPI messageAPI, final Map<Class<? extends Command>, CommandData> commandDataMap, final UserCache userCache) {
