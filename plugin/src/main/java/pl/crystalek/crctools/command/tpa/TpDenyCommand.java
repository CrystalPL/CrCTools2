...
public final class TpDenyCommand extends SingleCommand {
    UserCache userCache;

    public TpDenyCommand(final MessageAPI messageAPI, final Map<Class<? extends Command>, CommandData> commandDataMap, final UserCache userCache) {
