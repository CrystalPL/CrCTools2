...
public final class TpacceptCommand extends SingleCommand {
    UserCache userCache;

    public TpacceptCommand(final MessageAPI messageAPI, final Map<Class<? extends Command>, CommandData> commandDataMap, final UserCache userCache) {
