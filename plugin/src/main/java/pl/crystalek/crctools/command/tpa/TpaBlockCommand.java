...
public final class TpaBlockCommand extends SingleCommand {
    UserCache userCache;

    public TpaBlockCommand(final MessageAPI messageAPI, final Map<Class<? extends Command>, CommandData> commandDataMap, final UserCache userCache) {
