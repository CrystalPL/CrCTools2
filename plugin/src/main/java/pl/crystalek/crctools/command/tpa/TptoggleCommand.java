...
public final class TptoggleCommand extends SingleCommand {
    UserCache userCache;

    public TptoggleCommand(final MessageAPI messageAPI, final Map<Class<? extends Command>, CommandData> commandDataMap, final UserCache userCache) {
